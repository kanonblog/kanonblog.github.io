---
layout: post
title: "二年三班的日常 - (Ch.1) 花音與家政課"
date: 2021-05-30 21:11:00 +0800
...
<div class="table-content">
    ...
    <p>
    <ul>
    <li><a href="#set-A">預覽</a></li>
    <li><a href="#set-B">內容</a></li>
    <li><a href="#set-C">總結</a></li>
    </ul>
    </p>
</div>

<p><div class="left-margin" id="set-A"><h2>預覽</h2></div></p>
...
<p><div class="left-margin" id="set-B"><h2>內容</h2></div></p>
...
<p><div class="left-margin" id="set-C"><h2>總結</h2></div></p>

在家政課中，三人中或者有一人找不到事做，因為簡單的料理不需要這麼多人切食材或者煮食物。我想凪子就是被閒置的那一個。

Additional part for this article:<br>
